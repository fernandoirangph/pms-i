...
const ProjectModal = ({ show, onClose, onSubmit, formData, editingProjectId, setFormData }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Include the calculated status in the formData before submitting
    const updatedFormData = {
      ...formData,
      status: calculatedStatus, // Add the calculated status
    };

    onSubmit(updatedFormData); // Pass the updated formData to the parent onSubmit function
  };
